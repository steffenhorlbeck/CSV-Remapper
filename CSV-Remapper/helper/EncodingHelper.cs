...
namespace CSV_Remapper.helper
{
    ...
    public class EncodingHelper
    {
        ...
        /// <param name="defaultEncoding">The default encoding (default = "")</param>
        ...
        /// <param name="bomFound">out bool - Flag indicates the BOM was found in file</param>
        /// <returns>The detected encoding.</returns>
        private static Encoding GetEncodingByBom(string filename, out bool bomFound)
        {
            bomFound = true;
            ...
            */
            ...
            if (bom[0] == 0xFE && bom[1] == 0xFF)
                return Encoding.GetEncoding(1201); // 1201 unicodeFFFE Unicode (Big-Endian)
        ...
        {
            return DetectEncoding(stream, new[] { Encoding.ASCII, Encoding.UTF8, Encoding.GetEncoding(1252), Encoding.Unicode, Encoding.UTF32, Encoding.UTF7, Encoding.BigEndianUnicode }, new[] { "ö", "ü", "ä", "Ö", "Ü", "Ä", "ß" }, 100);
        }
        ...
        /// <returns>Das entsprechend gefundene Encoding. Wenn keins gefunden wurde, wird Encoding.Default zurückgegeben.</returns>
        private static Encoding DetectEncoding(FileStream stream, Encoding defaultEncoding)
        {
            return DetectEncoding(stream, new[] { Encoding.ASCII, Encoding.UTF8, Encoding.Unicode, Encoding.UTF32, Encoding.UTF7, Encoding.BigEndianUnicode }, new[] { "ö", "ü", "ä", "Ö", "Ü", "Ä", "ß" }, 100, defaultEncoding);
        }
        ...
        {
            return DetectEncoding(stream, toTest, new[] { "ö", "ü", "ä", "Ö", "Ü", "Ä", "ß" }, 100);
        }
        ...
        /// <param name="defaultEncoding">Encoding object (default null)</param>
        /// <returns>Das entsprechend gefundene Encoding. Wenn keins gefunden wurde, wird Encoding.Default zurückgegeben.</returns>
        private static Encoding DetectEncoding(FileStream stream, Encoding[] toTest, string[] manuChars, int testLines, Encoding defaultEncoding = null)
        {
